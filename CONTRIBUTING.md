...
> If you want to ask a question, I assume that you've read the available [Documentation](https://michaeljhanley.github.io/VectorCalculus.jl).

Before you ask a question, it is best to search for existing [Issues](https://github.com/michaeljhanley/VectorCalculus.jl/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/michaeljhanley/VectorCalculus.jl/issues/new).
...
- Check if there's already a bug report for it in the [bug tracker](https://github.com/michaeljhanley/VectorCalculus.jl/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/michaeljhanley/VectorCalculus.jl/issues/new). (Since it isn't yet confirmed as a bug, please don't label it yourself.)
...
This section covers suggestions for VectorCalculus.jl, including new features and improvements to existing functionality.
...
- Check the [documentation](https://michaeljhanley.github.io/VectorCalculus.jl) to see if it's already covered.
- Search [existing issues](https://github.com/michaeljhanley/VectorCalculus.jl/issues) to see if it's already been suggested; comment there instead of opening a duplicate.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/michaeljhanley/VectorCalculus.jl/issues).

- Use a clear, descriptive title.
- Describe the suggested enhancement step by step.
- Describe the current behavior and what you'd expect instead, and why.
- Explain why this would help most VectorCalculus.jl users. Pointing to how another package or library handles it can help make the case.
